...
////// Specular:
                ...
                float2 node_3126 = float2(i.posWorld.g,i.posWorld.b);
                float4 _node_5907 = tex2D(_Texture,TRANSFORM_TEX(node_3126, _Texture));
                float node_3474 = pow(abs(dot(i.normalDir,float3(0,1,0))),node_9724);
                float2 node_33 = float2(i.posWorld.r,i.posWorld.b);
                float4 _node_4242 = tex2D(_Texture,TRANSFORM_TEX(node_33, _Texture));
                float node_9210 = pow(abs(dot(i.normalDir,float3(0,0,1))),node_9724);
                float2 node_9497 = float2(i.posWorld.r,i.posWorld.g);
                float4 _node_5544 = tex2D(_Texture,TRANSFORM_TEX(node_9497, _Texture));
                float3 node_2317 = saturate(((_Color.rgb*((node_39*_node_5907.rgb)+(node_3474*_node_4242.rgb)+(node_9210*_node_5544.rgb)))+(((node_39*_node_5907.a)+(node_3474*_node_4242.a)+(node_9210*_node_5544.a))*_Drop_Value)));
                float3 diffuseColor = lerp((node_2317*_Locked_Drop),node_2317,i.vertexColor.r); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _node_5544 = tex2D(_Texture,TRANSFORM_TEX(node_9497, _Texture));
                float3 node_2317 = saturate(((_Color.rgb*((node_39*_node_5907.rgb)+(node_3474*_node_4242.rgb)+(node_9210*_node_5544.rgb)))+(((node_39*_node_5907.a)+(node_3474*_node_4242.a)+(node_9210*_node_5544.a))*_Drop_Value)));
                float3 diffColor = lerp((node_2317*_Locked_Drop),node_2317,i.vertexColor.r);
                float specularMonochrome;
                float3 specColor;
